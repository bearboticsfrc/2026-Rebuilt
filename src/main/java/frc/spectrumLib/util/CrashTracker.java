...
public class CrashTracker {
  ...
  /**
   * Logs details of a Throwable exception to a designated file. This method captures the unique run
   * instance UUID, the type of marker (in this case, "Exception"), the current date and time, and
   * the stack trace of the Throwable, if present. The log entry is appended to the file
   * '/home/lvuser/crash_tracking.txt', ensuring that each incident is recorded sequentially without
   * overwriting previous entries. This method is typically used to record unexpected exceptions or
   * crashes that occur during the runtime of the application, aiding in post-event analysis and
   * debugging.
   *
