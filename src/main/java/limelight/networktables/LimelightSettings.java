...
public class LimelightSettings {
  ...
  /**
   * Triggers rewind capture [counter, duration_seconds]. Increment counter to trigger. Max 165s via
   * NT. Rate-limited to once every 2 seconds; dropped if flush in progress
   */
  ...
  /**
   * Set the IMU Assist filter alpha/strength value. Higher values will cause the internal imu to
   * converge on assist source more rapidly.
   *
   * <p>This method changes the Limelight - normally immediately.
   *
  ...
  public enum ImuMode {
    /**
     * Use external IMU yaw submitted via {@link
     * LimelightSettings#withRobotOrientation(Orientation3d)} for MT2 localization. The internal IMU
     * is ignored entirely.
     */
    ExternalImu,
    /**
     * Use external IMU yaw submitted via {@link
     * LimelightSettings#withRobotOrientation(Orientation3d)} for MT2 localization. The internal IMU
     * is synced with the external IMU.
     */
    SyncInternalImu,
    /**
     * Use internal IMU for MT2 localization. Ignores external IMU updates from {@link
     * LimelightSettings#withRobotOrientation(Orientation3d)}.
     */
    InternalImu,
    /**
     * Use internal IMU for MT2 localization. The internal IMU will utilize filtered MT1 yaw
     * estimates for continuous heading correction.
     */
    InternalImuMT1Assist,
    /**
     * Use internal IMU for MT2 localization. The internal IMU will utilize the external IMU for
